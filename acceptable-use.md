...
You are responsible for everything published through your account, including AI output, automated updates, team activity, third-party embeds, and public visitor content. Review it before publishing and after updates. Have the rights, permissions, and notices needed for your content and collect only information you are entitled to collect.

Do not evade a restriction through another account, domain, slug, redirect, or substantially similar republication. Do not abuse rate limits, reserve names in bulk, overload the service, or use Revdoku to send unsolicited bulk messages.

Free publications cannot solicit or route payments, donations, tips, deposits, subscriptions, or wallet transfers. Paid publications may link to payment providers for permitted offerings with a clearly identified seller, destination, and purchase terms.
...
If we made a classification error, appeal at [support@revdoku.com](mailto:support@revdoku.com?subject=Appeal). We can restore content when it was misclassified or has been corrected to comply. Appeals do not create exceptions to the categories above or pause enforcement. Copyright counter-notices use the separate DMCA process.
