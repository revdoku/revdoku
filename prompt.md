...
11. Use that key to store, read, and update private workspace files in Revdoku. Publish a workspace only when I explicitly ask for a public link. New account connections get read/write access to normal workspaces and read access to the Library workspace by default.
